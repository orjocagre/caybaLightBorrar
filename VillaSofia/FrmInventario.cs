...
namespace VillaSofia
{
    public partial class FrmInventario : Form
    {
        ...
        public FrmInventario(int inicial, int idInventarioInicial, int idInventarioFinal, Boolean inventarioInicialGuardado, Boolean inventarioFinalGuardado)
        {
            this.idInventarioInicial = idInventarioInicial;
            this.idInventarioFinal = idInventarioFinal;
            this.inventarioInicialGuardado = inventarioInicialGuardado;
            this.inventarioFinalGuardado = inventarioFinalGuardado;
            cantTxt = 0;
            nomTxt = "";
            cantTxtA = 0;
            nomTxtA = "";
            ...
            this.Text = inicial == 1 ? "Inventario Inicial" : "Inventario Final";
        ...
        void cargarInventarioPreguardado()
        {
            ...
            if(inicial == 0)
            {
                DT = inventario.listarInventarioPreguardado(idInventarioFinal);
            }
            else
            {
                DT = inventario.listarInventarioPreguardado(idInventarioInicial);
            }
            ...
            if (inicial == 0)
            {
                DT = inventario.listarInventarioPreguardadoA(idInventarioFinal);
            }
            else
            {
                DT = inventario.listarInventarioPreguardadoA(idInventarioInicial);
            }
        ...
        void guardarInventario()
        {
            ...
            if(inicial == 1)
            {
                ...
                idInventarioInicial = idInventario;
                //fact.fechaInventario = DT;

            }
            else
            {
                inventarioFinalGuardado = true;
                idInventarioFinal = idInventario;
            }
